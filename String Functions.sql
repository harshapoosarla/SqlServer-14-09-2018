...
QuantityPurchased,
PricePerItem,
QuantityPurchased * PricePerItem as 'Price'
FROM Sales
...
SELECT DATEPART(month, '5/6/2017')  /* 5 */

SELECT DATEPART(day, '5/6/2017') /* 6 */

SELECT DATEPART(week, '5/6/2017') /* 18 */
